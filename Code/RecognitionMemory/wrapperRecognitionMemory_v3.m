...
%     end
    ...
    experiment_strings = {"NHS", "Industrial-Nature", "Textures", "Globalized-Music"};
    ...
    for block_number = curr_block_idx:length(block_order)
        ...
        fprintf("==========");
        fprintf('\nCurrent block: %d \ngroup id: %d\ncomputer id: %d\nsequence ID: %d\n', current_block, group_id, partition_id, dice_roll);
        fprintf("==========\n\n");

        recognitionMemoryMain_v3(subject_name, STATION, seq_for_exp, current_experiment, current_block, stimuli_type, dice_roll, stim_folder, group_id, partition_id);
