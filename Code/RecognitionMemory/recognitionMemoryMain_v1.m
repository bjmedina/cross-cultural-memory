% recognitionMemoryMain_v1(subject, STATION, sequence, condition, block, coin_flip)
%
...
function [uniquePositions, dprimeByPosition] = recognitionMemoryMain_v1(subject, STATION, sequence, condition, block, coin_flip)
    ...
    for trial = 1:numTrials
        ...
        stimulusFilename = sprintf('~/static2023/Stimuli/RecognitionMemory/%s/mem_exp_stim_%d.wav', stim_type, stimulusIndex);
    ...
    expmt_suffix = ['_RecognitionMem_v1_' date];
