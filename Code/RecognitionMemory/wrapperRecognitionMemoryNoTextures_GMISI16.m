function wrapperRecognitionMemoryNoTextures_ISI16
% wrapperRecognitionMemoryNoTextures_GMISI16 ->
% Runs memory experiment, excluding textures
% All blocks use ISI = 16 (including Globalized Music)
% Bryan Medina (28-07-2025)
    ...
    for block_number = curr_block_idx:length(block_order)
        ...
        % Load a unique stimulus sequence using ISI=16 for all blocks
