function wrapperRecognitionMemoryGMOnly
    % Bryan Medina (20-10-2025) - Simplified version for "Globalized-Music" experiment only
    ...
    gm_block_id = 4;  % "Globalized-Music" corresponds to index 3
    [seq_for_exp, stimuli_type, dice_roll, stim_folder] = getUniqueSequence(gm_block_id, group_id, computer_id);

    fprintf('\nCurrent experiment: Globalized Music\n');
    input('Press Enter once instructions have been given.\n');

    tstart = tic;
    recognitionMemoryMain_v3(subject_name, STATION, seq_for_exp, "Globalized-Music", gm_block_id, ...
