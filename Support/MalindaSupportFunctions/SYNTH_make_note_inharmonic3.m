function audio=SYNTH_make_note_inharmonic3(midi,vel,duration,fs,P)
STATION= P.STATION;
...
audio=zeros(size(tt));
    ...
    %for I=1:length(v)
        ...
        tone  = make_mel_harmsplit_v2(0, myfq, harm_nums, jitt_amt, jitt, length(tt)/fs,fs,dist,  centroid,SplitHalf,-Inf, JitterString);
