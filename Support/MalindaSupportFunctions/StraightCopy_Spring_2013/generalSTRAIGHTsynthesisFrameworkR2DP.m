...
%
%   19/Aug/2014 -- modified to separately synthesize periodic and aperiodic
%   components, to ensure that aperiodic component is the same across
%   different conditions -- Josh McDermott, at direction of Hideki Kawahara
...
for ii = 1:length(eventLocations)
  ...
  %jhm %outBuffer(copyIndex) = outBuffer(copyIndex)+response+responseAP;
  ...
  %jhm  %outBuffer(copyIndex) = outBuffer(copyIndex)+response;
    end;
end;
