function [sh, sw, sh_odd, sh_oct, sh_low, sh_unr, si_str, si_cmp] = ...
    StraightCopy2_expmt_conds_v3(x, fs, F0_downshift, lowest_harmonic, stretch_factor, cmp_vars, plot_sg)
