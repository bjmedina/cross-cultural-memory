function outputArgument = noiseBurstInFrequencyWhisper(commandString,currentDataStructure,randomHandleOption)
%   outBuffer = noiseBurstInFrequencyWhisper(buffer,fs,f0,stretch)
%   This version is used with the voiced speech spectrum to
%   simulate whispering.  It basically does the unvoiced synthesis,
%   but applies some scaling and filtering.
% 2012-08-29 Dan Ellis dpwe@ee.columbia.edu
...
%scaledown = 0.05;
scaledown = 1; % actually, perform the scaling down for simulated
               % whispering on the whole signal after combination
               % via an HPF
...
switch commandString
    ...
    case 'fetch'
        ...
        outputArgument = scaledown*fft(outputArgument);
end;
return;