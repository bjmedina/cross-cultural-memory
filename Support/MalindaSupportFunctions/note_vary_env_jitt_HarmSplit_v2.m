...
% v3 - removed amplitude envelope, July 11
function [signal, jitter_m] = note_vary_env_jitt_HarmSplit_v2(f0, harm_nums, jitt_amt,jitt, dur_s, sr, dist,JitterString, centroid, SplitHalf, dB_atten)
