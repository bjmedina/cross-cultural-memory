...
function [music_with_noise, filtered_noise_scaled] = filter_music_v1(original, fs, F0, low_harmonic, high_harmonic, set_midpoint_noise, dB_noise, No_noise, Type_noise);
...
scaled_filtered_noise = output_auditory_filter.*sqrt((power_signal/power_noise))*10^-(10/20);
...
filtered_noise_scaled = (pinknoise_signal.*sqrt(power_signal/power_noise)*10^-(10/20))';
