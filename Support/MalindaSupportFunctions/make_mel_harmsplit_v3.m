function [ s, jitter_matrix ] = make_mel_harmsplit_v1(mel, f0, harm_nums, jitt_amt,jitt, dur_s, sr, dist, centroid, SplitHalf, dB_atten,Jitter_Input_Vector)
...
for j=1:length(mel_ratio)
    ...
    [x, jitter_m] = note_vary_env_jitt_HarmSplit_v2(f,input_harms, jitt_amt,jitt, dur_s, sr, dist,JitterString, centroid, SplitHalfA, dB_atten);
    s = [s x];
