...
y1 = [zeros([1,low]), [1/gradientLow:1/gradientLow:1], ones([1,high-low-(length([1/gradientLow:1/gradientLow:1]))]), fliplr([1/gradientHigh:1/gradientHigh:1]), zeros([1,length(F1)-high-length(fliplr([1/gradientHigh:1/gradientHigh:1]))])]*dB-dB;
%plot(y1)
