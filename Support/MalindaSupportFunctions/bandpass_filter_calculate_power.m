function [filtered_signal, filter1, power_signal, power_signal_db, F] = bandpass_filter_calculate_power(input_wav_signal, fs, F0, low_harmonic, high_harmonic)
...
%low = round(F0*(low_harmonic));
%high =  round(F0*(high_harmonic));
