function [mel] = makeSpecShiftTone_singing_v2(nNMat, midi, dur, up_down, sr, isi)
...
harm_stack = [nNMat(1):nNMat(1)+5;nNMat(2):nNMat(2)+5];
else
harm_stack = [nNMat(2):nNMat(2)+5;nNMat(1):nNMat(1)+5;];
end
