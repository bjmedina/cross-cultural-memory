function ButtonName=cust7_questdlg(Question,Title,Btn1,Btn2,Btn3,Btn4,Btn5,Btn6,Btn7,Default)
...
if nargin>10, error('Too many input arguments');NumButtons=7;end
...
BtnXOffset=[MsgTxtXOffset 0 0 0 0 0 (FigPos(3)-DefOffset-BtnWidth)];
BtnXOffset(4)=(BtnXOffset(1)+BtnXOffset(7))/2;
BtnXOffset(2)=(BtnXOffset(1)+(BtnXOffset(7)-BtnXOffset(1))/6);
BtnXOffset(3)=(BtnXOffset(1)+(BtnXOffset(7)-BtnXOffset(1))/6*2);
BtnXOffset(5)=(BtnXOffset(1)+(BtnXOffset(7)-BtnXOffset(1))/6*4);
BtnXOffset(6)=(BtnXOffset(1)+(BtnXOffset(7)-BtnXOffset(1))/6*5);
