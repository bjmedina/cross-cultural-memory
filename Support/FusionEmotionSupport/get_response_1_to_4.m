...
function [response, repeated, instruction] = get_response_1_to_4(k, total_trials, response_prompt_string, pahandle, OutWav, sr)
...
while ~done
    ...
    elseif ~(strcmp(response,'1') || strcmp(response,'2') || strcmp(response,'3') || strcmp(response,'4') || ...
        ...
        response = input(['Invalid response - must enter 1, 2, 3, or 4, or 1i, 2i, 3i, 4i:   '],'s');
    else
        done = 1;
    end
end
