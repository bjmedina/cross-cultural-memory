function noise_calibration_testJarrod(device,ear,output_spl)
...
%
% Last modified by Jarrod Hicks on 12/07/17 because the device ID wasn't
% working correctly. Just switched to default and things seemed to work
