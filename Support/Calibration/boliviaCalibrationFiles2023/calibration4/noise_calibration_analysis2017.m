function noise_calibration_analysis2017(device, ears, input_speclevel)
...
%
% Last edited by JMH on 12/07/17 to change wavread to audioread since it's
% no longer supported in MATLAB 2017a
...
for j = 1:length(ears)
    ...
    wav = audioread([pwd '/noise-recordings/' device '-ear' ears{j} '.WAV']);
