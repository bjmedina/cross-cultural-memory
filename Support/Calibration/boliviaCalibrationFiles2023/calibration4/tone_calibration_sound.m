function tone_calibration_sound(ear, input_speclevel)
...
% pink gaussian noise with 4 dB per octave attenuation
stim = tonecomplex2(freqs, input_speclevel + spec_atten*log2(freqs(1)./freqs), dur, sr);%, 'phases', phases);
% fftplot2(stim,sr);
% xlim(passband);
% plot(stim); drawnow;
