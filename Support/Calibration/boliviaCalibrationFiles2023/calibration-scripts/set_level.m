...
%
% June 06, 2017 -- Ray Gonzalez raygon@mit.edu; Calibrated booths
...
% if ~contains(booth_ear_string,'Booth')
%     error(['argument "booth_ear_string" should be of form "Booth#Ear", eg. "Booth3Left" '...
%            'Found: ' booth_ear_string]);
% end
