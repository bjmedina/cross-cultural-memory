...
function rec=nori_do_play_record_macpc2(y,fs0,DEV,verbosity,BEG)
...
for I=1:length(devs)
    ...
    if strcmp(strrep(devs(I).DeviceName,' ',''),strrep(DEVi,' ',''))
...
for I=1:length(devs)
    ...
    if strcmp(strrep(devs(I).DeviceName,' ',''),strrep(DEVo,' ',''))
