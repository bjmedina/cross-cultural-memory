function [fq,midi,start_stop,more]=detect_pitch_nori_yinonly5(recaudio,fs,ISPLOT,vocal_range_midi)
...
CUT_PRE=75/1000;  %time ignored at the begning of each segment.
CUT_POST=75/1000; %time ignored at the end of each segment.
MINon=35/1000; % minimal time in sec that segment should have.
...
if ISPLOT
    ...
    plot(tt,real((fq2midi(FF0t)).*(v>TH)));hold all;
    plot(tt,real((fq2midi(FF0t))));hold all;
