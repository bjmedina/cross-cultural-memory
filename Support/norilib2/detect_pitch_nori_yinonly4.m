function [fq,midi,start_stop,more]=detect_pitch_nori_yinonly4(recaudio,fs,ISPLOT,vocal_range_midi)
...
CUT_PRE=900/1000;  %time ignored at the begning of each segment.
CUT_POST=900/1000; %time ignored at the end of each segment.
MINon=40/1000; % minimal time in sec that segment should have.
