...
for J=1:REPET,
        for K=1:NTRIALS,
            ...
            fname=sprintf('%s_%d_1_%02d_TRIAL=%d_REPEAT=%d_T1=%d_T2=%d_dev=%d.wav',EXPname,EXPID,myTOTperm(idx),K,J,T1,T2,mydev)
            ...
            myseq=STIMcreateBruno(fname,FS,Nbeats,T1,T2,rangeJump,BEG,clicksound);
