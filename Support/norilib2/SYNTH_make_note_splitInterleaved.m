function audio=SYNTH_make_note_splitInterleaved(midi,vel,duration,fs,P)
...
if isfield(P,'LFO')
    ...
    %for I=1:length(v)
        myfq=fq;
        tone  = make_mel_harmsplit_v1(0, myfq, P.harm_nums, P.jitt_amt, P.jitt, length(tt)/fs,fs,P.dist,  P.centroid,P.SplitHalfa,-Inf, []);
        %make_mel_harmsplit_v1(mel, f0, harm_nums, jitt_amt,jitt, dur_s, sr, dist, centroid, SplitHalf, dB_atten,Jitter_Input_Vector)
