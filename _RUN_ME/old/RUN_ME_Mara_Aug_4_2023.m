...
%% Market Integration Experiments
%% ONLY RUN ON MEN
CODE_DIR = '~/Tsimane2023/Code/Preference/';
addpath(CODE_DIR)
PreferenceExperiments_2023_v1
%% High Pitch Preference 
CODE_DIR = '~/Tsimane2023/Code/HighPitch/';
addpath(CODE_DIR)
Wrapper_HighPitchPref_2023_v3
%% Environmental Sounds Only 
CODE_DIR = '~/Tsimane2023/Code/HighPitch/';
addpath(CODE_DIR)
Wrapper_EnvironmentalSounds_2023_v1
...
addpath(CODE_DIR)
Run_Demography_Tsimane_2023_v4
%% Audiometry
